...
# DocBook XSL
  ...
  # html chunk
  DOCBOOK2HTML_CHUNK_XSL=$DOCBOOK_XSL/html/chunk.xsl
  ...
  # xhtml
  DOCBOOK2XHTML_XSL=$DOCBOOK_XSL/xhtml/docbook.xsl
  ...
  # xhtml chunk
  DOCBOOK2XHTML_CHUNK_XSL=$DOCBOOK_XSL/xhtml/chunk.xsl
...
# conclusion
  ...
  DOCBOOK_WORKS=no
  if test "$DOCBOOK_CAT_WORKS $DOCBOOK2XHTML_WORKS $DOCBOOK2XHTML_CHUNK_WORKS $DOCBOOK2HTML_WORKS $DOCBOOK2HTML_CHUNK_WORKS $DOCBOOK2MAN_WORKS $XSLTPROC_WORKS" = "yes yes yes yes yes yes yes"; then
    DOCBOOK_WORKS=yes
  fi
