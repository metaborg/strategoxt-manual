...
# conclusion
  ...
  DOCBOOK_WORKS=no
  if test "$DOCBOOK_RNG_WORKS $DOCBOOKXI_RNG_WORKS $DOCBOOK2XHTML_WORKS $DOCBOOK2XHTML_CHUNK_WORKS $DOCBOOK2HTML_WORKS $DOCBOOK2HTML_CHUNK_WORKS $DOCBOOK2MAN_WORKS $XSLTPROC_WORKS" = "yes yes yes yes yes yes yes yes"; then
    DOCBOOK_WORKS=yes
  fi
